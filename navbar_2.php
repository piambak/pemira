                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav align-middle">
                            <!--li class="align-middle"><a href="#beranda" class="active">Beranda</a></li>
        ...
        <div class="modal-content">
            ...
            <form method="post" action="./action/login">
                <div class="modal-body">
                    ...
                    <a class="text-danger text-end pe-auto" href="#" data-bs-toggle="modal" data-bs-target="#lupa_password"><small>Lupa Password?</small></a>
                </div>
                <div class="modal-footer">
